...
7. [FAQ](#faq)
8. [Support and Contacts](#support-and-contacts)
...
- **List Products**
  ...
  ```http
  GET /products?pagination[page]=1&pagination[pageSize]=10
...
<Cards>
  <Card  title="Strapi" href="/pages/development/api/strapi.mdx" />
</Cards>
#### List Products
